...
constexpr int64_t KDA_MAX_TILING_CHUNKS = 4096;
...
TILING_DATA_FIELD_DEF_ARR(uint32_t, KDA_MAX_TILING_CHUNKS, chunkMap);
TILING_DATA_FIELD_DEF_ARR(uint32_t, KDA_MAX_TILING_SEQUENCES, seqStart);
TILING_DATA_FIELD_DEF_ARR(uint32_t, KDA_MAX_TILING_SEQUENCES, seqEnd);
END_TILING_DATA_DEF;
